...
class Transaction5Controller extends Controller
{
    public function index()
    {
        $title = 'Rejected of Partner Offer';
        $http = new Client();
        ...
        return view('admin.transactions-5.index', compact('response', 'title'));
    }
    ...
    public function status($id)
    {
        ...
        return redirect('/u/transaction5')->with('success', "Pengajuan berhasil disetujui pada " . Carbon::now());
        // dd($id);
    }
    ...
    public function reject(Request $request, $id)
    {
        ...
        return redirect('/u/transaction5')->with('success', "Pengajuan berhasil ditolak pada " . Carbon::now());
        // dd($id);
    }
