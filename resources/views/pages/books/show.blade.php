...
@section('content')
    <div class="row">
        <div class="col-md-12 mb-3">
            <a href="/" class="text-decoration-none float-end text-dark"><span class="fa fa-chevron-left me-1"></span>
                Back</a>
        ...
        <div class="col-md-8 mb-3 px-3">
            <p class="color-star float-end"><span class="fa fa-star me-2"></span>
                {{ number_format((float) $books->rating, 2, '.', '') }}</p>
            ...
            <p class="top-8 color-grey fs-normal text-grey font-regular"><b class="font-medium text-dark">Author</b> -
                {{ $books->author->name }}</p>
            <p class="top-8 color-grey fs-normal text-grey font-regular"><b class="font-medium text-dark">Publisher</b> -
                {{ $books->publisher->name }}</p>

            @auth
                <a href="#" data-bs-toggle="modal" data-bs-target="#addCartModal"
                    class="btn btn-sm btn-primary rad-8 px-3 py-2 font-regular float-end"><span
                        class="fa fa-shopping-bag me-1"></span> Add to Cart</a>
            @else
                <a href="/login" class="btn btn-sm btn-primary rad-8 px-3 py-2 font-regular float-end"><span
                        class="fa fa-shopping-bag me-1"></span> Add to Cart</a>
            @endauth
