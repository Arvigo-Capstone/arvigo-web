                            ...
                            <td style="text-align: center">
                                @if ($item->status == 'unpaid')
                                    <span style="color: #dc3545"
                                        class="badge bg-badge-danger px-3 py-2 font-medium text-danger rad-6 fs-small">Unpaid</span>
                                @else
                                    <span style="color: #000000"
                                        class="badge bg-badge-success px-3 py-2 font-medium color-primary rad-6 fs-small">Paid</span>
                                @endif
                            </td>
                        </tr>
                    @endforeach
