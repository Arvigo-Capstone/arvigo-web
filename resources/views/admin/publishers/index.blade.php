    ...
    <div class="container fs-normal">
        ...
        <div class="card shadow mb-5 border-0">
            <div class="card-body">
                ...
                <a href="/u/publisher/create" class="btn btn-primary py-2 px-3 fs-normal float-right mb-3 shadow-sm"><span
                            ...
                            @foreach ($response['data'] as $row)
                                <tr>
                                    ...
                                    {{-- <td class="text-center">
                                        <form action="/u/publisher/{{ $row['id'] }}"
                                            onsubmit="return confirm('Apakah anda yakin akan menghapus data?')"
                                            method="post">
                                            @csrf
                                            @method('DELETE')

                                            <a href="/u/publisher/edit/{{ $row['name'] }}"
