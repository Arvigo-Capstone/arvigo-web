                                ...
                                @foreach ($item['products'] as $product)
                                    @if ($product['status'] === 'REJECTED')
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-badge-danger p-2 text-danger rad-6 fs-small">REJECTED</span>
                                            </td>
                                            <td>
                                                <a href="#" class="btn btn-sm btn-primary" data-toggle="modal"
                                                    data-target="#exampleModalReson">Alasan</a>
                                                <div class="modal fade" id="exampleModalReson" tabindex="-1" role="dialog"
                                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                            ...
                                            <td>
                                                @if ($product['status'] == 'REJECTED')
                                                    <a href="/u/transaction5/{{ $product['id'] }}/status"
