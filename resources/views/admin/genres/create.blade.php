    ...
    <div class="container fs-normal">
        ...
        <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-end">
                <a href="/u/genre" class="btn btn-primary mx-2 py-2 shadow-sm fs-normal align-self-center px-3 mt-n3">
        ...
        <div class="card shadow mb-4 border-0">
            ...
            <div class="card-body container-fluid">
                <form method="post" action="/u/genre">
                    @csrf
                    <div class="form-group">
                        <label for="genre">Genre Buku</label>
                        <input type="text" placeholder="ex: Petualangan"
                            class="form-control fs-normal form-spacer-20x15 @error('genre') is-invalid @enderror"
                            id="genre" name="genre" data-toggle="tooltip" data-placement="right"
                            title="genre Lengkap Bayi" value="{{ old('genre') }}" autofocus>
                        @error('genre')
