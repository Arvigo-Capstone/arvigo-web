                ...
                <form method="post" action="{{ url('/u/book') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Nama Produk"
                            ...
                            value="{{ $responseWithId['data']['name'] }}">
                        @error('name')
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="description" class="form-control fs-normal" id="description" placeholder="Desckripsi"
                                value="{{ $responseWithId['data']['description'] }}"></textarea>
                            @error('description')
                                <div class="invalid-feedback ml-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" multiple="multiple"
                            ...
                            name="images[]" data-toggle="tooltip" data-placement="right"
                            value="{{ implode(',', $responseWithId['data']['images']) }}">
                        @error('images[]')
                            <div class="invalid-feedback ml-1">{{ $message }}</div>
                        @enderror
                    </div>
