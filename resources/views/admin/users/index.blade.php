    ...
    <div class="container fs-normal">
        ...
        <div class="card shadow mb-5 border-0">
            <div class="card-body">
                ...
                @if ($title == 'Admins')
                    <a href="/u/users/create" class="btn btn-primary py-2 px-3 fs-normal float-right mb-3 shadow-sm"><span
              ...
              <td>{{ ($row->gender == 'L') ? 'Laki-laki' : 'Perempuan' }}</td> --}}
                                    {{-- <td class="text-center">
                                        @if ($title == 'Admins')
                                            <a href="/u/admins/{{ $row->user_id }}/edit"
                                        ...
                                        @if ($title == 'Customers')
                                            <form action="/u/users/{{ $row->user_id }}"
