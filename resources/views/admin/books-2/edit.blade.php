                    ...
                    <div class="row">
                        <div class="col-xl-6 mr-auto">
                            ...
                            <div class="form-group">
                                ...
                                <select id="publisher_id" name="publisher_id" placeholder="Nama Bayi"
                                    class="form-control-select fs-normal form-spacer-10x8 @error('publisher_id') is-invalid @enderror"
                                    data-toggle="tooltip" data-placement="right">
                                    @foreach ($publishers as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $books->publisher_id == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}</option>
                                    @endforeach
                                </select>
                                @error('publisher_id')
                            ...
                            <div class="form-group">
                                ...
                                <select id="genre_id" name="genre_id" placeholder="Nama Bayi"
                                    class="form-control-select fs-normal form-spacer-10x8 @error('genre_id') is-invalid @enderror"
                                    data-toggle="tooltip" data-placement="right">
                                    @foreach ($genres as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $books->genre_id == $item->id ? 'selected' : '' }}>{{ $item->genre }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('genre_id')
                        ...
                        <div class="col-xl-6 ml-auto">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="Harga"
                                    class="form-control fs-normal form-spacer-20x15 @error('price') is-invalid @enderror"
                                    id="price" name="price" data-toggle="tooltip" data-placement="right"
                                    value="{{ $books->price }}">
                                @error('price')
                                    <div class="invalid-feedback ml-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" placeholder="Date"
                                            class="form-control fs-normal form-spacer-20x15 @error('publish_date') is-invalid @enderror"
                                            id="publish_date" name="publish_date" data-toggle="tooltip"
                                            data-placement="right" value="{{ $books->publish_date }}">
                                        @error('publish_date')
                                            <div class="invalid-feedback ml-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Jumlah Halaman"
                                            class="form-control fs-normal form-spacer-20x15 @error('book_pages') is-invalid @enderror"
                                            id="book_pages" name="book_pages" data-toggle="tooltip" data-placement="right"
                                            value="{{ $books->book_pages }}">
                                        @error('book_pages')
                                            <div class="invalid-feedback ml-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="Bintang"
                                    class="form-control fs-normal form-spacer-20x15 @error('rating') is-invalid @enderror"
                                    id="rating" name="rating" data-toggle="tooltip" data-placement="right"
                                    value="{{ $books->rating }}">
                                @error('rating')
                                    <div class="invalid-feedback ml-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset('storage/' . $books->cover_image) }}" class=""
